...
fun NameVerifyScreen(onContinue: () -> Unit) {
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = Strings.NameVerify.subtitle,
            ...
            OutlinedTextField(
                ...
                label = { Text(Strings.NameVerify.fieldLabel) },
                placeholder = { Text(Strings.NameVerify.fieldLabel) },
                singleLine = true,
    ...
    if (showDialog) {
        FunDialog(
            message = Strings.NameVerify.wrongMessage,
            onDismiss = { showDialog = false },
            title = Strings.NameVerify.dialogTitle,
        )
    }
}
...
private fun attemptsLabel(remaining: Int): String = when (remaining) {
    3 -> Strings.NameVerify.attempts3
    2 -> Strings.NameVerify.attempts2
    1 -> Strings.NameVerify.attempts1
    else -> Strings.NameVerify.attemptsAutoFilled
}
